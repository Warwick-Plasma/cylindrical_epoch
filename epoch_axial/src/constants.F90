...
MODULE constants
  ...
  COMPLEX(num), PARAMETER :: imagi = CMPLX(0.0_num, 1.0_num, num)
  ...
  INTEGER, PARAMETER :: c_stagger_exm = c_stagger_face_y
  INTEGER, PARAMETER :: c_stagger_erm = c_stagger_face_x
  INTEGER, PARAMETER :: c_stagger_etm = c_stagger_edge_z
  INTEGER, PARAMETER :: c_stagger_bxm = c_stagger_erm
  INTEGER, PARAMETER :: c_stagger_brm = c_stagger_exm
  INTEGER, PARAMETER :: c_stagger_btm = c_stagger_face_z
  INTEGER, PARAMETER :: c_stagger_jxm = c_stagger_exm
  INTEGER, PARAMETER :: c_stagger_jrm = c_stagger_erm
  INTEGER, PARAMETER :: c_stagger_jtm = c_stagger_etm
  ...
  INTEGER, PARAMETER :: c_dump_exm               = 72
  INTEGER, PARAMETER :: c_dump_erm               = 73
  INTEGER, PARAMETER :: c_dump_etm               = 74
