...
CONTAINS
  ...
  SUBROUTINE deallocate_memory
    ...
    DEALLOCATE(exm, erm, etm)
    DEALLOCATE(bxm, brm, btm)
    DEALLOCATE(jxm, jrm, jtm)
    DEALLOCATE(bxm_old, brm_old, btm_old)
    DEALLOCATE(jxm_old, jrm_old, jtm_old)
    ...
    DEALLOCATE(exm_x_min, exm_x_max, erm_x_min, erm_x_max, etm_x_min, etm_x_max)
    DEALLOCATE(bxm_x_min, bxm_x_max, brm_x_min, brm_x_max, btm_x_min, btm_x_max)
