...
CONTAINS
  ...
  SUBROUTINE mpi_initialise
    ...
    ALLOCATE(exm(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(erm(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(etm(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(bxm(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(brm(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(btm(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(bxm_old(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(brm_old(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ALLOCATE(btm_old(1-ng:nx+ng, 1-ng:ny+ng, 0:n_mode-1))
    ! Current may need an extra layer of ghostcells.
    ALLOCATE(jxm(1-jng:nx+jng, 1-jng:ny+jng, 0:n_mode-1))
    ALLOCATE(jrm(1-jng:nx+jng, 1-jng:ny+jng, 0:n_mode-1))
    ALLOCATE(jtm(1-jng:nx+jng, 1-jng:ny+jng, 0:n_mode-1))
    ALLOCATE(jxm_old(1-jng:nx+jng, 1-jng:ny+jng, 0:n_mode-1))
    ALLOCATE(jrm_old(1-jng:nx+jng, 1-jng:ny+jng, 0:n_mode-1))
    ALLOCATE(jtm_old(1-jng:nx+jng, 1-jng:ny+jng, 0:n_mode-1))
